...
$! VPACK Version 1.8, Tuesday, February 04, 1997, 11:10:20
$!
...
c
	...
	character*8 format
        ...
        integer rdgr
c
      call ifmessage('XYZPIC version 13-DEC-96')
c
      call xveaction('SA',' ')
c
...
c		open the 3-D graphics-1 file
	status = RDGR (1, 1, 3)              ! check for missing file
...
c			ignoring points that fall outside of the image
	...
	call ISORT (linearray, pointer, numpoints)
c        call ISORTP (
