$!****************************************************************************
$!
$! Build proc for MIPL module libjpl_mipl_spice
$! VPACK Version 1.9, Thursday, May 02, 2002, 09:47:58
$!
$! Execute by entering:		$ @libjpl_mipl_spice
$!
...
$!****************************************************************************
$!
$ write sys$output "*** module libjpl_mipl_spice ***"
$!
$ Create_Source = ""
$ Create_Repack =""
$ Create_Imake = ""
...
$ write sys$output "Invalid argument given to libjpl_mipl_spice.com file -- ", primary
...
$!
$Run_Make_File:
$   if F$SEARCH("libjpl_mipl_spice.imake") .nes. ""
$   then
$      vimake libjpl_mipl_spice
$      purge libjpl_mipl_spice.bld
$   else
$      if F$SEARCH("libjpl_mipl_spice.bld") .eqs. ""
$      then
$         gosub Imake_File
$         vimake libjpl_mipl_spice
$      else
...
$   if (primary .eqs. " ")
$   then
$      @libjpl_mipl_spice.bld "STD"
$   else
$      @libjpl_mipl_spice.bld "''primary'" "''secondary'"
$   endif
$ Return
$!#############################################################################
$Repack_File:
$ create libjpl_mipl_spice.repack
$ DECK/DOLLARS="$ VOKAGLEVE"
$ vpack libjpl_mipl_spice.com -mixed -
	-s jpl_mipl_spice_jni_SpiceLib.c -
	-i libjpl_mipl_spice.imake -
	-d make_jpl_mipl_spice.bat
$ Exit
$ VOKAGLEVE
$ Return
$!#############################################################################
$Source_File:
$ create jpl_mipl_spice_jni_SpiceLib.c
$ DECK/DOLLARS="$ VOKAGLEVE"
...
$!#############################################################################
$Imake_File:
$ create libjpl_mipl_spice.imake
#define PROGRAM libjpl_mipl_spice

#define MODULE_LIST jpl_mipl_spice_jni_SpiceLib.c
...
$!#############################################################################
$Doc_File:
$ create make_jpl_mipl_spice.bat
$ DECK/DOLLARS="$ VOKAGLEVE"
