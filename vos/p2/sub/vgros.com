$!****************************************************************************
$!
$! Build proc for MIPL module vgros
$! VPACK Version 1.6, Wednesday, August 25, 1993, 11:28:09
$!
$! Execute by entering:		$ @vgros
$!
...
$!
$Run_Make_File:
$   if F$SEARCH("vgros.imake") .nes. ""
$   then
$      vimake vgros
$      purge vgros.bld
$   else
$      if F$SEARCH("vgros.bld") .eqs. ""
$      then
$         gosub Imake_File
$         vimake vgros
$      else
...
$ vpack vgros.com -
	-s vgros.f zvgros.c -
	-i vgros.imake -
	-t tvgros.f tzvgros.c tvgros.imake tvgros.pdf tstvgros.pdf -
	-o vgros.hlp
$ Exit
$ VOKAGLEVE
$ Return
...
$ create vgros.f
$ DECK/DOLLARS="$ VOKAGLEVE"
      SUBROUTINE VGROS(ICAM,LOC)
C ROUTINE TO FETCH VOYAGER OBJECT SPACE RESEAU
      REAL*4 LOC(2,202)
...
C  MILOSH OBJECT SPACE RESEAU LOCATIONS FOR S/N 7 (L,S)
     ...
     *  177.66,  730.16/
C
      IF (ICAM.LT.4.OR.ICAM.GT.7) GOTO 10

      IF (ICAM.EQ.4) THEN
          CALL MVE(7,102,LOC4,LOC,1,1)
          CALL MVE(7,102,LOD4,LOC(1,52),1,1)
          CALL MVE(7,102,LOE4,LOC(1,103),1,1)
          CALL MVE(7,98,LOF4,LOC(1,154),1,1)
      ENDIF

      IF (ICAM.EQ.5) THEN
          CALL MVE(7,102,LOC5,LOC,1,1)
          CALL MVE(7,102,LOD5,LOC(1,52),1,1)
          CALL MVE(7,102,LOE5,LOC(1,103),1,1)
          CALL MVE(7,98,LOF5,LOC(1,154),1,1)
      ENDIF

      IF (ICAM.EQ.6) THEN
          CALL MVE(7,102,LOC6,LOC,1,1)
          CALL MVE(7,102,LOD6,LOC(1,52),1,1)
          CALL MVE(7,102,LOE6,LOC(1,103),1,1)
          CALL MVE(7,98,LOF6,LOC(1,154),1,1)
      ENDIF

      IF (ICAM.EQ.7) THEN
          CALL MVE(7,102,LOC7,LOC,1,1)
          CALL MVE(7,102,LOD7,LOC(1,52),1,1)
          CALL MVE(7,102,LOE7,LOC(1,103),1,1)
          CALL MVE(7,98,LOF7,LOC(1,154),1,1)
      ENDIF

      RETURN
C
   10 CALL PRNT(4,1,ICAM,' **INVALID CAMERA S/N.')
      CALL ABEND
      END
$ VOKAGLEVE
$!-----------------------------------------------------------------------------
...
$Imake_File:
$ create vgros.imake
/* Imake file for VICAR subroutine VGROS */

#define SUBROUTINE vgros

#define MODULE_LIST vgros.f zvgros.c
...
$!-----------------------------------------------------------------------------
$ create tvgros.imake
/* Imake file for Test of VICAR subroutine VGROS */

#define PROGRAM tvgros

#define MODULE_LIST tvgros.f tzvgros.c
