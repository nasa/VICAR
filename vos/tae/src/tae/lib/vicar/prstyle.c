 ...
 */
    ...
    FUNCTION static VOID auto_list (st)
 ...
 */
    ...
    FUNCTION static VOID auto_sublist (subs)
 ...
 */
    ...
    FUNCTION static CODE esc_ps (procctx)
 ...
 */
    ...
    FUNCTION static CODE get_ps (pmtbuf, cmdstr)
	...
	if (code == F_FILERR)
	    {
	    m_put("Error reading script file.", "TAE-RDERR");
	    cmdstr[0] = EOS;
	    return(FAIL);
	    }
	if (term == T_ESCAPE)
 ...
 */
    ...
    FUNCTION static CODE get_psip (pmtbuf, cmdstr)
...
/*      ps_exit_do  "do" function for prompt style exit command.   */
   ...
   FUNCTION CODE ps_exit_do(procctx,cmdctx)
 ...
 */
    ...
    FUNCTION CODE ps_help_do (procctx, cmdctx)
    ...
    struct VARIABLE *	lookex();	/* find a variable in a symbol table */
    BOOL		s_equal();	/* compare strings		*/
    TEXT *		s_save();	/* save a string in dynamic memory */
...
help_err:
    tmmsg(PROCFAIL, helpblk.errmsg, helpblk.errkey);
    return(DO_CHECK);
    }

/*
 ...
 */
    ...
    FUNCTION static CODE ps_initial (ctx)
 ...
 */
    ...
    FUNCTION struct ITRCMD * ps_intrin (cmd)
 ...
 */
    ...
    FUNCTION struct ITRCMD * ps_itrsub(subcmd, p)
 ...
 */
    ...
    FUNCTION static CODE ps_mandatory (ctx)
 ...
 */
   ...
   FUNCTION CODE ps_nothing_do(procctx,cmdctx)
 ...
 */
    ...
    FUNCTION static CODE ps_prccmd (procctx, cmdstr)
    ...
    struct ITRCMD *	ps_intrin();
    struct ITRCMD *	ps_itrsub();
    BOOL		s_equal();
 ...
 */
    ...
    FUNCTION static CODE ps_subinitial (ctx, sub_str)
    ...
    COUNT		s_length();		/* return length of a string */
 ...
 */
    ...
    FUNCTION CODE ps_tutor_do (procctx, cmdctx)
    ...
    IMPORT CODE parmlatch ;
    IMPORT struct CONTXT latchctx ;
 ...
 */
    ...
    FUNCTION CODE psdyn (parblk, pdf, ctx, dash_present)
 ...
 */
    FUNCTION CODE psparm (pdf, ctx, held_msg, held_key)
 ...
 */
    ...
    FUNCTION CODE pssub (parblk, pdf, ctx, dash_present, sub_str)
 ...
 */
    ...
    FUNCTION static VOID put_initial (v, last_prompt)
 ...
 */
    ...
    FUNCTION static CODE ps_updval (v, cmdstr)
 ...
 */
    ...
    FUNCTION CODE move_locals (p, locst)
