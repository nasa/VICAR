...
#include	"sessinc.inc"		/* session log struct */
    ...
    GLOBAL  v28slog = 0;		/* version number */
...
#define		MSGLOGSIZ   STRINGSIZ+KEYSIZ+3	/* allow for key string */
    ...
    static VOID slprocnm();
    static CODE slforprm();
    static CODE slforgbl();
    static VOID outname();
    static VOID outvalue();
 ...
 */
    ...
    FUNCTION  static VOID  slprocnm(ctx)
 ...
 */
    ...
    FUNCTION  static VOID  slforprm(ctx)
 ...
 */
    ...
    FUNCTION  VOID  slparm(prefix, symtab)
 ...
 */
    ...
    FUNCTION  static  VOID  slforgbl(ctx)
 ...
 */
    ...
    FUNCTION  static VOID  outname(prefix, name, line, length)
 ...
 */
    ...
    FUNCTION  static VOID  outvalue(prefix, vv, index, line, stdlen, longlen,
					 lastflag)
 ...
 */
    ...
    FUNCTION  VOID  slwrite(prefix, line)
 ...
 */
    ...
    FUNCTION   VOID  logmsg(ctx, parblk)
    ...
    IMPORT struct VARIABLE *msg_gbl;	/* pointer to $MESSAGE variable */
	...
	msgtext[0] = EOS;
	m_pfmt(SVAL(*v1, 0), SVAL(*v2, 0), msgtext);  	/* format output  */
 ...
 */
    ...
    FUNCTION  static   VOID  add_trace(ctx, record)
 ...
 */
    ...
    FUNCTION CODE sl2write(record, breakup)
