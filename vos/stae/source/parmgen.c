 ...
 */
    ...
    FUNCTION CODE p_attr (block, name, type, n, dflt, access)
 ...
 */
    ...
    FUNCTION VOID p_get_root (name, root, remainder)
 ...
 */
    ...
    FUNCTION VOID p_get_leaf (name, leaf, remainder) 
 ...
 */
    ...
    FUNCTION struct VARIABLE *p_fvar (block, name)
 ...
 */
    ...
    struct VARIABLE  *p_find (block, name)
 ...
 */
    ...
    FUNCTION CODE p_intg (block, name, dimen, intg, count)
 ...
 */
    ...
    FUNCTION CODE p_real (block, name, dimen, real, count)
 ...
 */
    ...
    FUNCTION CODE p_string  (block, name, sptr, count)
...
(
    ...
    COUNT		(*convert) (char*, TAEINT*),	/* in: conversion function		*/
