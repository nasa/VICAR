...
FUNCTION VOID synerr (FAST struct SYNBLK *sb, FAST TEXT *es);	
FUNCTION VOID igfdp (struct SYNBLK *sb);
...
FUNCTION VOID addqu (FAST TEXT *s)
    {
...
(
    ...
    i    = MAX(1, (*sb).errchr - (*sb).inichr - (nchar/2) + 1);
