...
/**
 * VicarDataOutputStream lets an application write primitive
...
public
class VicarDataOutputStream extends FilterOutputStream implements DataOutput {
     ...
     */
    public VicarDataOutputStream(OutputStream out, int intFmtCode,
				 int realFmtCode) {
        super(out);
