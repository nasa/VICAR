...
/**
 * VicarVaxDataInputStream lets an application read primitive
 ...
 */
public
class VicarVaxDataInputStream extends VicarDataInputStream 
implements DataInput 
{
    /**
     * Creates a new VicarVaxDataInputStream to read data from the specified 
     * input stream. 
     *
     * @param  in     the input stream you`re wrapping
     * @param  format the data format to convert *from*
     */
    public VicarVaxDataInputStream(InputStream in,
	...
	long int1 = (long) in.read();
	long int2 = (long) in.read();
