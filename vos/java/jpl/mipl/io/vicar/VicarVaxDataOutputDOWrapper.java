...
/**
 * VicarVaxDataOutputDOWrapper lets an application write primitive
 ...
 * constructor.
 * <p>
 * This is exactly like VicarVaxDataOutputStream except the thing being wrapped
 * is a <code>DataOutput</code> instead of a <code>OutputStream</code>.
 * @see VicarVaxDataOutputStream
 */

public
class VicarVaxDataOutputDOWrapper extends VicarDataOutputDOWrapper
{
     ...
     */
    public VicarVaxDataOutputDOWrapper(DataOutput output, int intFmtCode,
				    int realFmtCode) {
