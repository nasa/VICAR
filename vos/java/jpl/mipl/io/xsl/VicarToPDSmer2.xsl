        ...
        <xsl:choose>
            <xsl:when test="@name='IDENTIFICATION'">
                <CLASS>
                    ...
                    <xsl:apply-templates select="/VICAR_LABEL/PROPERTY[@name='IDENTIFICATION']/item[@name='SPACECRAFT_CLOCL_CNT_PARTITION']"/>
                    ...
                    <item>
                        ...
                        <xsl:if test="contains(following-sibling::item/@name,'__UNIT')">
                            ...
                            <xsl:attribute name="unit">
                                <xsl:value-of select="following-sibling::item[@name]"/>
                            </xsl:attribute>
                        </xsl:if>
                        <xsl:choose>
        ...
        <xsl:element name="subitem">
            ...
            <xsl:choose>
                <xsl:when test="contains(../following-sibling::item/subitem/@name, '__UNIT')">
                    <xsl:attribute name="unit">
                        <xsl:value-of select="../following-sibling::item/subitem[@name]"/>
                    </xsl:attribute>
                </xsl:when>
            </xsl:choose>
            <xsl:value-of select="."/>
