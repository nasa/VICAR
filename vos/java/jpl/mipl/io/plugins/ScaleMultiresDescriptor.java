 ...
 * "ScaleMultires" dynamically.
 */
class ScaleMultiresPropertyGenerator extends PropertyGeneratorImpl {

    /** Constructor. */
    public ScaleMultiresPropertyGenerator() {
 ...
 */
public class ScaleMultiresDescriptor extends OperationDescriptorImpl {
	...
	private static final String[][] resources = {
        {"GlobalName",  "ScaleMultires"},
        {"LocalName",   "ScaleMultires"},
        {"Vendor",      "jpl.mipl.io"},
    ...
    /** Constructor. */
    public ScaleMultiresDescriptor() {
    ...
    public PropertyGenerator[] getPropertyGenerators() {
        ...
        pg[0] = new ScaleMultiresPropertyGenerator();
        return pg;
    }
    ...
    public static RenderedOp create(RenderedImage source0,
        ...
        // check source RenderedImageList CollectionImage
        // if (source0 instanceOf RenderedImageList ) RenderedImageList is a subclass of CollectionImage
        if (source0 instanceof CollectionImage) {
        	ParameterBlockJAI pb =
                new ParameterBlockJAI("ScaleMultires",
            ...
            System.out.println("ScaleMultiresDescriptor .create ScaleMultires");
        	return JAI.create("ScaleMultires", pb, hints);
        } else {
        	 ParameterBlockJAI pb =
             ...
             pb.setParameter("yTrans", yTrans);
             pb.setParameter("interpolation", interpolation);
             System.out.println("ScaleMultiresDescriptor .create Scale");
    ...
    public static RenderableOp createRenderable(RenderableImage source0,
        ...
        if (source0 instanceof CollectionImage) {
            ...
            pb.setParameter("yTrans", yTrans);
            pb.setParameter("interpolation", interpolation);
            System.out.println("ScaleMultiresDescriptor .createRenderable ScaleMultires");
        	return JAI.createRenderable("ScaleMultires", pb, hints);
        } else {
        	 ParameterBlockJAI pb =
                 new ParameterBlockJAI("Scale",
                                       RenderedRegistryMode.MODE_NAME);
             ...
             pb.setParameter("yTrans", yTrans);
             pb.setParameter("interpolation", interpolation);
             System.out.println("ScaleMultiresDescriptor .createRenderable Scale");
