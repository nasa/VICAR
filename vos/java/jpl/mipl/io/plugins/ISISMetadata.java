/*
 * @(#)ISISMetadata.java	1.0 02/01/17
 *
 ...
 */
public class ISISMetadata extends IIOMetadata implements Cloneable {
    ...
    public static final String nativeImageMetadataFormatName = "ISIS_LABEL";    
      //   nativeImageMetadataFormatName = "jpl.mipl.io.plugins.pdsimage";    
        // this isn't defined yet - this is a placeholder
        
        public static final String 
        nativeImageMetadataFormatClassName = "jpl.mipl.io.plugins.ISISMetadataFormat";
 ...
 public ISISMetadata(IIOMetadata metadata) {
 	...
 	public ISISMetadata(Document doc) {
 ...
 // Deep clone
    public Object clone() {
        ISISMetadata metadata = null;
        try {
            metadata = (ISISMetadata)super.clone();
...
// Build IIOMetadataFormat classes for my formats
   ...
   */
        ...
        if (commonNode == null ) {
            if (nativeDoc != null) {
                ...
                ***/
                ...
                System.out.println("no ISIS Document set");
    ...
    * for ISISMetadata to hold.
    *
    *************************/
    public void setFromTree(String formatName, Node root) {
        if (debug) System.out.println("ISISMetadata.setFromTree() "+formatName);
