...
(
 ...
 TAEINT		*intgr		/* out: the integer		*/
    ...
    ena_over();				/* enable integer overflow trap	*/
    ena_under();			/* enable floating underflow	*/
 ...
 *
 */
FUNCTION static VOID handler(int ignore)
