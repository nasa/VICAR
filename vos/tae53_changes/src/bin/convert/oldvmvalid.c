 ...
 */
    ...
    FUNCTION CODE Vm_SetValidString(
 ...
 */
    ...
    FUNCTION CODE Vm_SetOneValidString(
...
COUNT Vm_ValidSize(FAST FUNINT, FAST FUNINT);
    FUNCTION GENPTR Vm_AllocValid(
 ...
 */
    ...
    {
    FAST COUNT	basic;		/* size of valid COUNT plus one range	*/
    FAST COUNT  increment;	/* size of additional ranges		*/
