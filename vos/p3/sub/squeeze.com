$!****************************************************************************
$!
$! Build proc for MIPL module squeeze
$! VPACK Version 1.5, Friday, March 19, 1993, 19:46:56
$!
$! Execute by entering:		$ @squeeze
$!
...
$!****************************************************************************
$!
$ write sys$output "*** module squeeze ***"
$!
$ Create_Source = ""
$ Create_Repack =""
$ Create_Imake = ""
...
$!
$Run_Make_File:
$   if F$SEARCH("squeeze.imake") .nes. ""
$   then
$      vimake squeeze
$      purge squeeze.bld
$   else
$      if F$SEARCH("squeeze.bld") .eqs. ""
$      then
$         gosub Imake_File
$         vimake squeeze
$      else
...
$      @squeeze.bld "STD"
$   else
$      @squeeze.bld "''primary'" "''secondary'"
$   endif
$ Return
$!#############################################################################
$Repack_File:
$ create squeeze.repack
...
$!#############################################################################
$Imake_File:
$ create squeeze.imake
#define SUBROUTINE squeeze

#define MODULE_LIST squeeze.f
