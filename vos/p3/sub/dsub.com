$!****************************************************************************
$!
$! Build proc for MIPL module dsub
$! VPACK Version 1.9, Monday, March 08, 2010, 10:12:04
$!
$! Execute by entering:		$ @dsub
$!
...
$ write sys$output "Invalid argument given to dsub.com file -- ", primary
...
$!
$Run_Make_File:
$   if F$SEARCH("dsub.imake") .nes. ""
$   then
$      vimake dsub
$      purge dsub.bld
$   else
$      if F$SEARCH("dsub.bld") .eqs. ""
$      then
$         gosub Imake_File
$         vimake dsub
$      else
...
$Imake_File:
$ create dsub.imake
#define SUBROUTINE dsub

#define MODULE_LIST dsub.f
