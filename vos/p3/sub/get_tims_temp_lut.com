$!****************************************************************************
$!
$! Build proc for MIPL module get_tims_temp_lut
$! VPACK Version 1.8, Thursday, October 08, 1998, 15:43:10
$!
$! Execute by entering:		$ @get_tims_temp_lut
$!
...
$!****************************************************************************
$!
$ write sys$output "*** module get_tims_temp_lut ***"
$!
$ Create_Source = ""
$ Create_Repack =""
$ Create_Imake = ""
...
$ write sys$output "Invalid argument given to get_tims_temp_lut.com file -- ", primary
...
$!
$Run_Make_File:
$   if F$SEARCH("get_tims_temp_lut.imake") .nes. ""
$   then
$      vimake get_tims_temp_lut
$      purge get_tims_temp_lut.bld
$   else
$      if F$SEARCH("get_tims_temp_lut.bld") .eqs. ""
$      then
$         gosub Imake_File
$         vimake get_tims_temp_lut
$      else
...
$   if (primary .eqs. " ")
$   then
$      @get_tims_temp_lut.bld "STD"
$   else
$      @get_tims_temp_lut.bld "''primary'" "''secondary'"
$   endif
$ Return
$!#############################################################################
$Repack_File:
$ create get_tims_temp_lut.repack
$ DECK/DOLLARS="$ VOKAGLEVE"
$ vpack get_tims_temp_lut.com -
	-s get_tims_temp_lut.f -
	-i get_tims_temp_lut.imake
$ Exit
$ VOKAGLEVE
$ Return
$!#############################################################################
$Source_File:
$ create get_tims_temp_lut.f
$ DECK/DOLLARS="$ VOKAGLEVE"
...
$!#############################################################################
$Imake_File:
$ create get_tims_temp_lut.imake
#define SUBROUTINE get_tims_temp_lut

#define MODULE_LIST get_tims_temp_lut.f
