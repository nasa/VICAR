$!****************************************************************************
$!
$! Build proc for MIPL module alphae_re
$! VPACK Version 1.8, Thursday, January 11, 1996, 16:43:14
$!
$! Execute by entering:		$ @alphae_re
$!
...
$!****************************************************************************
$!
$ write sys$output "*** module alphae_re ***"
$!
$ Create_Repack =""
$ Create_PDF = ""
$ Create_Imake = ""
...
$ write sys$output "Invalid argument given to alphae_re.com file -- ", primary
...
$!
$Run_Make_File:
$   if F$SEARCH("alphae_re.imake") .nes. ""
$   then
$      vimake alphae_re
$      purge alphae_re.bld
$   else
$      if F$SEARCH("alphae_re.bld") .eqs. ""
$      then
$         gosub Imake_File
$         vimake alphae_re
$      else
...
$      @alphae_re.bld "STD"
$   else
$      @alphae_re.bld "''primary'" "''secondary'"
$   endif
$ Return
$!#############################################################################
$Repack_File:
$ create alphae_re.repack
...
$!#############################################################################
$PDF_File:
$ create alphae_re.pdf
! VICAR procedure to do calculate alpha emissivity by iteration
...
! ALPHAE allowed input parameters
...
! Call alphae once to get an emissivity image to use with TIMSCAL2RE
alphae inp=&gtemporary out=&etemporary wave=&wave
...
END-PROC
.HELP
Program to calculate alpha emissivity by iteration.  
.LEVEL1
.VARIABLE INP
...
$!#############################################################################
$Imake_File:
$ create alphae_re.imake
#define  PROCEDURE alphae_re
