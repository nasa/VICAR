$!****************************************************************************
$!
$! Build proc for MIPL module timscal2
$! VPACK Version 1.8, Monday, October 23, 2000, 16:39:32
$!
$! Execute by entering:		$ @timscal2
$!
...
$!****************************************************************************
$!
$ write sys$output "*** module timscal2 ***"
$!
$ Create_Source = ""
$ Create_Repack =""
$ Create_PDF = ""
...
$ write sys$output "Invalid argument given to timscal2.com file -- ", primary
...
$!
$Run_Make_File:
$   if F$SEARCH("timscal2.imake") .nes. ""
$   then
$      vimake timscal2
$      purge timscal2.bld
$   else
$      if F$SEARCH("timscal2.bld") .eqs. ""
$      then
$         gosub Imake_File
$         vimake timscal2
$      else
...
$      @timscal2.bld "STD"
$   else
$      @timscal2.bld "''primary'" "''secondary'"
$   endif
$ Return
$!#############################################################################
$Repack_File:
$ create timscal2.repack
...
$!#############################################################################
$Imake_File:
$ create timscal2.imake
#define  PROGRAM   timscal2

#define MODULE_LIST timscal2.f
