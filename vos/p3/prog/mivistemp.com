$!****************************************************************************
$!
$! Build proc for MIPL module mivistemp
$! VPACK Version 1.8, Monday, February 08, 1999, 23:44:42
$!
$! Execute by entering:		$ @mivistemp
$!
...
$!****************************************************************************
$!
$ write sys$output "*** module mivistemp ***"
$!
$ Create_Source = ""
$ Create_Repack =""
$ Create_PDF = ""
...
$ write sys$output "Invalid argument given to mivistemp.com file -- ", primary
...
$!
$Run_Make_File:
$   if F$SEARCH("mivistemp.imake") .nes. ""
$   then
$      vimake mivistemp
$      purge mivistemp.bld
$   else
$      if F$SEARCH("mivistemp.bld") .eqs. ""
$      then
$         gosub Imake_File
$         vimake mivistemp
$      else
...
$      @mivistemp.bld "STD"
$   else
$      @mivistemp.bld "''primary'" "''secondary'"
$   endif
$ Return
$!#############################################################################
$Repack_File:
$ create mivistemp.repack
...
$!#############################################################################
$Imake_File:
$ create mivistemp.imake
#define  PROGRAM   mivistemp

#define MODULE_LIST mivistemp.f
