$!****************************************************************************
$!
$! Build proc for MIPL module tes_re
$! VPACK Version 1.8, Thursday, January 11, 1996, 16:43:33
$!
$! Execute by entering:		$ @tes_re
$!
...
$!****************************************************************************
$!
$ write sys$output "*** module tes_re ***"
$!
$ Create_Repack =""
$ Create_PDF = ""
$ Create_Imake = ""
...
$ write sys$output "Invalid argument given to tes_re.com file -- ", primary
...
$!
$Run_Make_File:
$   if F$SEARCH("tes_re.imake") .nes. ""
$   then
$      vimake tes_re
$      purge tes_re.bld
$   else
$      if F$SEARCH("tes_re.bld") .eqs. ""
$      then
$         gosub Imake_File
$         vimake tes_re
$      else
...
$      @tes_re.bld "STD"
$   else
$      @tes_re.bld "''primary'" "''secondary'"
$   endif
$ Return
$!#############################################################################
$Repack_File:
$ create tes_re.repack
