$!****************************************************************************
$!
$! Build proc for MIPL module mastertoa
$! VPACK Version 1.8, Friday, November 12, 2004, 18:16:51
$!
$! Execute by entering:		$ @mastertoa
$!
...
$!****************************************************************************
$!
$ write sys$output "*** module mastertoa ***"
$!
$ Create_Source = ""
$ Create_Repack =""
$ Create_PDF = ""
...
$ write sys$output "Invalid argument given to mastertoa.com file -- ", primary
...
$!
$Run_Make_File:
$   if F$SEARCH("mastertoa.imake") .nes. ""
$   then
$      vimake mastertoa
$      purge mastertoa.bld
$   else
$      if F$SEARCH("mastertoa.bld") .eqs. ""
$      then
$         gosub Imake_File
$         vimake mastertoa
$      else
...
$      @mastertoa.bld "STD"
$   else
$      @mastertoa.bld "''primary'" "''secondary'"
$   endif
$ Return
$!#############################################################################
$Repack_File:
$ create mastertoa.repack
...
$!#############################################################################
$Imake_File:
$ create mastertoa.imake
#define  PROGRAM   mastertoa

#define MODULE_LIST mastertoa.f
