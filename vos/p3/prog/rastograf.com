...
$! VPACK Version 1.8, Thursday, March 20, 1997, 12:05:45
$!
...
C 20 MAR 1997 ...REA... fix method of computing LINOFFSET so that it is
C			correct for any extra lines after the last full block
C
	INCLUDE 'VICMAIN_FOR'
C
	SUBROUTINE MAIN44
...
C
        CALL IFMESSAGE('RASTOGRAF version 20-MAR-97')
