...
$! VPACK Version 1.8, Wednesday, February 28, 2001, 16:30:35
$!
...
C
      CALL IFMESSAGE('GRID version 26-FEB-01')
...
C
      ...
      IF (MULDEF.LE.1) GO TO 50
         CALL XVMESSAGE('REPLACE, MULTIPLY, and ADD may not be 
     &used together.',' ')
         CALL ABEND
	 ...
	 MODE=3
      ...
      IF (MODE.EQ.2) GO TO 60
         IF (LIM.EQ.0) GO TO 60
            CALL XVMESSAGE('LIMIT may be used only with MULTIPLY 
     &option. ',' ')
  	    CALL ABEND
